...
CelestialBody.Io=Io=new CelestialBody(7.8276E+20,170587.68,6888188.012,new Orbit(Jupiter,39745554.2,0.003545858426,0.05,358.0466432,231.2703461,195.327409));
...
CelestialBody.Ganymede=Ganymede=new CelestialBody(1.3107E+21,247136.9373,21515132.07,new Orbit(Jupiter,100849827.5,0.001190086418,0.2,358.0125219,139.2992571,232.6753229));
CelestialBody.Callisto=Callisto=new CelestialBody(9.5356E+20,226907.14,58857839.19,new Orbit(Jupiter,177416873.9,0.007973319797,0.192,358.5022563,320.7359683,15.81614025));
CelestialBody.Saturn=Saturn=new CelestialBody(4.5455E+24,5388585.4,9513,new Orbit(Sun,134190879508,0.05347166507,2.485,5.970845344,85.04661203,67.46885226));
CelestialBody.Mimas=Mimas=new CelestialBody(3.3290E+17,18666.4155,20347.2,new Orbit(Saturn,17518297.79,0.01776275223,1.574,139.7604722,222.2172789,125.5909782));
CelestialBody.Enceladus=Enceladus=new CelestialBody(9.3631E+17,23742.7,29596.7088,new Orbit(Saturn,22453729.47,0.006227898,0.009,128.4244162,115.5615886,346.6301477));
...
CelestialBody.Dione=Dione=new CelestialBody(9.6974E+18,52872.48,59117.364,new Orbit(Saturn,35567023.12,0.001679230906,0.019,128.5606071,123.6717156,167.9272785));
CelestialBody.Rhea=Rhea=new CelestialBody(2.0460E+19,71934.45,97593.3792,new Orbit(Saturn,49652726.1,0.001168269516,0.345,130.3670575,172.736709,13.48887719));
CelestialBody.Titan=Titan=new CelestialBody(1.2087E+21,242352.6,344412,new Orbit(Saturn,115084407.5,0.02891936562,0.34854,126.4945234,182.0886765,75.16117359));
...
CelestialBody.Titania=Titania=new CelestialBody(3.1320E+19,74298.36,36197226.68,new Orbit(Uranus,41089911.75,0.002486916,0.34,166.6555215,165.7455424,212.6552822));
...
CelestialBody.Triton=Triton=new CelestialBody(1.8961E+20,127462.8,126943.25,new Orbit(Neptune,33411870.74,0.000168801436,156.885,197.195324,220.4523287,358.6561878));
CelestialBody.Pluto=Pluto=new CelestialBody(1.1573E+20,111791.23,137964.168,new Orbit(Sun,550543475615,0.2462772488,17.14,44.36099837,184.4945352,300.1297305));
CelestialBody.Charon=Charon=new CelestialBody(1.3771E+19,56837.45,137964.1766,new Orbit(Pluto,1845563.556,0.00005082225659,0.08,222.4053736,188.4738647,30.8998924));
